...
# Enable Web Interface and register user daniel
sudo rabbitmq-plugins enable rabbitmq_management
sudo rabbitmqctl add_user 'daniel' 'daniel'
sudo rabbitmqctl set_permissions -p "/" 'daniel' '.*' '.*' '.*'
rabbitmqctl set_user_tags "daniel" "administrator"

# Set up rabbitmqadmin and create both queues
